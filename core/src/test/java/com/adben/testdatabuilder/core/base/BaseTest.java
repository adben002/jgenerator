...
public class BaseTest extends AbstractDataBuilderTest {
    ...
    public void setUp() {
        ...
        DATA_BUILDER
                .reset()
                .add(core(TestSubBean.class)
                        .overrides(ovrrdSet(TestSubBean.class)
                ...
                .add(core(TestBean.class, TEST_BEAN_COUNT)
                        .overrides(ovrrdSet(TestBean.class)
                                ...
                                .idx(INDEX, coreFields(TestBean.class, new Overrider<TestBean>() {
                                    ...
                                    public void setFields(final TestBean o) {
                                        ...
                                        o.setSubBean(builtLookup(TestSubBean.class, 0)
                                                .lookup());
                                    }
                                }))))
                .build();
    ...
    public void testClzs() {
        assertThat(core(TestSubBean.class).getClzs(), is((Iterable<Class<?>>)
                Lists.<Class<?>>newArrayList(TestSubBean.class)));
    }
    ...
    public void testGetEntity() {
        assertThat(
                DATA_BUILDER.getAllByClz(TestSubBean.class).get(0),
                equalTo(DATA_BUILDER.getByClz(TestSubBean.class, 0)));
        assertThat(DATA_BUILDER.getAllByClz(TestBean.class).get(0), equalTo(DATA_BUILDER.getByClz(TestBean.class, 0)));
    }
