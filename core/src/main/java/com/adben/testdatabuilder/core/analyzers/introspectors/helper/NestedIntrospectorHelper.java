...
public final class NestedIntrospectorHelper {
     ...
     */
    public static List<Object> findNestedClasses(final Class<?> clz, final Object obj, final Cmd cmd) {

        LOGGER.debug("Find nested {}. Cmd: {}. Object to put onto stack if {} not found: {}", clz, cmd, clz, obj);
     ...
     * IntrospectorStore#NESTED} or a newly built object.
     */
    public static List<Object> findNestedClasses(final Class<?> clz, final Cmd cmd) {

        LOGGER.debug("Find nested {}. Cmd: {}.", clz, cmd);
     ...
     * IntrospectorStore#NESTED} or a newly built object.
     */
    private static List<Object> findNestedClassesImpl(final Class<?> clz, final Object obj, final Cmd cmd) {
