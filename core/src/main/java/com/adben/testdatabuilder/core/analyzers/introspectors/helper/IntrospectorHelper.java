...
public final class IntrospectorHelper {
     ...
     */
    public static <T> T performIntrospection(
            final T newInstance, final Introspector introspector, final Collection<String> fieldsToSkip)
            throws IllegalAccessException {

        LOGGER.debug("Build {}, with introspector: {}. Skip fields: {}", newInstance, introspector, fieldsToSkip);
