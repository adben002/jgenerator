...
public class BooleanGenerator extends AbstractGenerator<Boolean> {
    ...
    protected boolean isApplicable(final Type type) {
        return Boolean.class.isAssignableFrom(getClz(type)) || Objects.equals(getClz(type), boolean.class);
    }
    ...
    public String toString() {
        ...
        return MoreObjects.toStringHelper(this).add("currValue", this.currValue).toString();
    }
}
