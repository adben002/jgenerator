...
public class TestBean {
  ...
  private List<List<List<List<List<List<List<List<List<Character>>>>>>>>> hugeList = Lists
      .newArrayList();
  ...
  public void setHugeList(
      final List<List<List<List<List<List<List<List<List<Character>>>>>>>>> hugeList) {
  ...
  public String toString() {
    return "TestBean{" +
        ...
        ", j1='" + this.j1 + '\'' +
        ", k1=" + this.k1 +
        ", subBean=" + this.subBean +
        ", l1=" + this.l1 +
        ", m1=" + this.m1 +
        ", n1=" + this.n1 +
        ", o1=" + this.o1 +
        ", hugeList=" + this.hugeList +
        '}';
  }
